...
{
   // Check if there are conditions to set
  if (selects->condition_num == 0) {
    return;
  }
  // Ensure the number of condition operators matches the number of conditions
  ...
  // Set the end condition operator
...
{
  // Ensure that the number of joins doesn't exceed the capacity of the selects
...
{
   // Set the order policies and order attributes for the selects
...
{
  // Set the group by attributes for the selects
...
{
  // Set the having condition and mark that having is enabled
